...
export const MAXIMUM_REQUESTS_ALLOWED_PER_TTL: number =
  EnvironmentVariables.NODE_ENV === "test" ? 10 : 100;
...
export const TIME_TO_LIVE_IN_SECONDS: number =
  EnvironmentVariables.NODE_ENV === "test" ? 1000 : 60000;
