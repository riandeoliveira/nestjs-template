...
exports.RenewUserRefreshTokenUseCase = void 0;
...
let RenewUserRefreshTokenUseCase = class RenewUserRefreshTokenUseCase {
    ...
    execute(request) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.authService.validateTokenOrThrow(request.refreshToken);
            const user = yield this.userRepository.findCurrentOrThrow();
            const currentPersonalRefreshToken = yield this.personalRefreshTokenRepository.findOneOrThrow({
            ...
            yield this.personalRefreshTokenRepository.update(currentPersonalRefreshToken, {
                hasBeenUsed: true,
            });
...
exports.RenewUserRefreshTokenUseCase = RenewUserRefreshTokenUseCase;
exports.RenewUserRefreshTokenUseCase = RenewUserRefreshTokenUseCase = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [auth_service_1.AuthService,
        personal_refresh_token_repository_1.PersonalRefreshTokenRepository,
        user_repository_1.UserRepository])
], RenewUserRefreshTokenUseCase);
//# sourceMappingURL=renew-user-refresh-token.use-case.js.map