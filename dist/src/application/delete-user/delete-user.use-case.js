...
let DeleteUserUseCase = class DeleteUserUseCase {
    constructor(personalRefreshTokenRepository, userRepository) {
    ...
    execute() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.userRepository.softDelete(user);
            yield this.personalRefreshTokenRepository.softDeleteMany({
                userId: user.id,
            });
        });
    }
