...
let SignInUserUseCase = class SignInUserUseCase {
    ...
    execute(request) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!user)
                throw new common_1.UnauthorizedException(response_messages_enum_1.ResponseMessages.INVALID_CREDENTIALS);
            const isPasswordValid = yield password_utility_1.PasswordUtility.verify(request.password, user.password);
            if (!isPasswordValid) {
                throw new common_1.UnauthorizedException(response_messages_enum_1.ResponseMessages.INVALID_CREDENTIALS);
            }
            const currentPersonalRefreshToken = yield this.personalRefreshTokenRepository.findFirstOrThrow({
                userId: user.id,
                hasBeenUsed: false,
                deletedAt: null,
            });
...
exports.SignInUserUseCase = SignInUserUseCase = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [auth_service_1.AuthService,
        personal_refresh_token_repository_1.PersonalRefreshTokenRepository,
        user_repository_1.UserRepository])
], SignInUserUseCase);
//# sourceMappingURL=sign-in-user.use-case.js.map