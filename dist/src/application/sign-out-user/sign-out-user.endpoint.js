...
exports.SignOutUserEndpoint = void 0;
...
let SignOutUserEndpoint = class SignOutUserEndpoint {
    constructor(useCase) {
...
exports.SignOutUserEndpoint = SignOutUserEndpoint;
__decorate([
...
], SignOutUserEndpoint.prototype, "handle", null);
exports.SignOutUserEndpoint = SignOutUserEndpoint = __decorate([
    (0, api_endpoint_decorator_1.ApiEndpoint)("user"),
    (0, authorize_decorator_1.Authorize)(),
    __metadata("design:paramtypes", [sign_out_user_use_case_1.SignOutUserUseCase])
], SignOutUserEndpoint);
//# sourceMappingURL=sign-out-user.endpoint.js.map