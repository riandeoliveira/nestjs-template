...
exports.UpdateUserEndpoint = void 0;
...
const update_user_request_1 = require("./update-user.request");
const update_user_use_case_1 = require("./update-user.use-case");
let UpdateUserEndpoint = class UpdateUserEndpoint {
    constructor(useCase) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [update_user_request_1.UpdateUserRequest]),
    __metadata("design:returntype", Promise)
], UpdateUserEndpoint.prototype, "handle", null);
exports.UpdateUserEndpoint = UpdateUserEndpoint = __decorate([
...
//# sourceMappingURL=update-user.endpoint.js.map